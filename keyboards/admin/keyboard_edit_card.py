...
def keyboard_action_card() -> InlineKeyboardMarkup:
    """
    ...
    button_1 = InlineKeyboardButton(text=f'Добавить',
                                    callback_data=f'action_add_card')
    button_2 = InlineKeyboardButton(text=f'Редактировать',
                                    callback_data=f'action_edit_card')
    button_3 = InlineKeyboardButton(text=f'Удалить',
                                    callback_data=f'action_del_card')
